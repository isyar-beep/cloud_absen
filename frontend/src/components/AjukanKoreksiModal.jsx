    ...
    >
      ...
      >
        <div className="px-5 py-4 border-b border-gray-100">
          <p className="text-sm font-bold text-gray-900">Ajukan Koreksi Absensi</p>
          <p className="text-xs text-gray-500 mt-0.5">{formatTanggalHari(baris.date)}</p>
        </div>
        ...
        <form onSubmit={kirim} className="p-5 space-y-4">
          ...
          <div className="bg-gray-50 rounded-xl px-3.5 py-2.5">
            <p className="text-[11px] text-gray-400 mb-0.5">Tercatat sekarang</p>
